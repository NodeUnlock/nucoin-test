    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Nucoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  nucoind [options]                     " + "\n" +
                  "  nucoind [options] <command> [params]  " + _("Send command to -server or nucoind") + "\n" +
                  "  nucoind [options] help                " + _("List commands") + "\n" +
                  "  nucoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: nucoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Nucoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Nucoin is probably already running."), strDataDir.c_str()));
